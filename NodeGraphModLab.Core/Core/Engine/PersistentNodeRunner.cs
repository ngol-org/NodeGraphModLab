...
public sealed class PersistentNodeRunner
{
    ...
    {
        var reg = new PersistentRegistration(nodeInstanceId, displayName, graphName, callbacks);
        lock (_lock)
        {
    ...
    internal sealed class PersistentRegistration : IPersistentRegistration
    {
        ...
        public PersistentRegistration(string nodeInstanceId, string displayName, string graphName, PersistentCallbacks callbacks)
        {
            NodeInstanceId = nodeInstanceId;
            DisplayName = displayName;
            GraphName = graphName;
