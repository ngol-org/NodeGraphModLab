...
<img src="docs/images/webui.png" alt="NGOL WebUI" align="left" /><br clear="left" />
...
MCP サーバー（`mcp/`）を AI エージェントに接続する場合は、[mcp/README.md](mcp/README.md) で基本的な使い方を確認してから `mcp/mcp.json.example` で設定してください。
...
<img src="docs/images/dotnet_startup_hooks_sample.png" alt="DOTNET_STARTUP_HOOKS injection sample" align="left" /><br clear="left" />
